...
We generate pseudo-realistic data following the approach proposed on page 15, based on order book data from certain stocks on the Paris Stock Exchange ("BOUYGUES", "LVMH", "SANOFI", "TOTAL").  
